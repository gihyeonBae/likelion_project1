...
document.getElementById('admin-summary').innerHTML = `
  <a class="category-card" href="/src/admin/menu/read/list/index.html">
    <p>Menus</p>
  ...
  <a class="category-card" href="/src/admin/category/read/index.html">
    <p>Categories</p>
  ...
  <a class="category-card" href="/src/admin/menu/create/index.html">
    <p>Create</p>
    <h3>메뉴 등록</h3>
    <span>신규 커피, 음료, 디저트, 베이커리 메뉴를 추가합니다.</span>
  </a>
  <a class="category-card" href="/src/admin/order/read/list/index.html">
    <p>Orders</p>
  ...
  <a class="category-card" href="/src/admin/customer/read/list/index.html">
    <p>Customers</p>
