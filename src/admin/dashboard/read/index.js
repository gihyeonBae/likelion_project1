...
document.getElementById('admin-summary').innerHTML = `
  <a class="category-card" href="/src/admin/menu/read/list">
    <p>Menus</p>
  ...
  <a class="category-card" href="/src/admin/category/read">
    <p>Categories</p>
  ...
  <a class="category-card" href="/src/admin/menu/create">
    <p>Create</p>
    <h3>메뉴 등록</h3>
    <span>신규 커피, 음료, 디저트, 베이커리 메뉴를 추가합니다.</span>
  </a>
  <a class="category-card" href="/src/admin/order/read/list">
    <p>Orders</p>
  ...
  <a class="category-card" href="/src/admin/customer/read/list">
    <p>Customers</p>
