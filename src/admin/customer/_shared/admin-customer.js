  ...
  return `
    <article class="order-card">
      ...
      <div class="cart-item__actions">
        <a class="button button--ghost" href="${basePath}/src/admin/customer/read/detail/index.html?id=${customer.id}">상세</a>
        <a class="button button--ghost" href="${basePath}/src/admin/customer/update/status/index.html?id=${customer.id}">상태</a>
      </div>
    </article>
  `;
}
