  ...
  return `
    <article class="order-card">
      ...
      <div class="cart-item__actions">
        <a class="button button--ghost" href="${basePath}/src/admin/inventory/update/index.html?id=${item.id}">수정</a>
        <a class="button button--ghost" href="${basePath}/src/admin/inventory/read/history/index.html?id=${item.id}">입고 기록</a>
        <a class="button button--ghost" href="${basePath}/src/admin/inventory/delete/index.html?id=${item.id}">삭제</a>
      </div>
    </article>
  `;
}
