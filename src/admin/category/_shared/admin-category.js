  ...
  return `
    <article class="order-card">
      ...
      <div class="cart-item__actions">
        <a class="button button--ghost" href="/src/admin/category/update?id=${category.id}">수정</a>
        <a class="button button--ghost" href="/src/admin/category/delete?id=${category.id}">삭제</a>
      </div>
    </article>
  `;
}
