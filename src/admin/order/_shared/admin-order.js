  ...
  return `
    <article class="order-card">
      ...
      <div class="cart-item__actions">
        <a class="button button--ghost" href="/src/admin/order/read/detail?id=${order.id}">상세</a>
        <a class="button button--ghost" href="/src/admin/order/update/status?id=${order.id}">상태</a>
      </div>
    </article>
  `;
}
