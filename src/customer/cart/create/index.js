...
if (!menu) {
  ...
  container.innerHTML = `
    <div class="empty-state">
      ...
      <a class="button button--primary" href="/src/customer/menu/read/list">다른 메뉴 보기</a>
    </div>
  `;
} else {
  container.innerHTML = `
    <article class="cart-form-layout">
      ...
      <form class="panel-form" id="cart-form">
        ...
        <div class="detail-actions">
          ...
          <a class="button button--ghost" href="/src/customer/menu/read/detail?id=${menu.id}">상세로 돌아가기</a>
        </div>
      </form>
    </article>
  `;
