...
if (!order) {
  container.innerHTML = `
    <div class="empty-state">
      ...
      <a class="button button--primary" href="../../order/read/list/index.html">주문 내역</a>
    </div>
  `;
  ...
  container.innerHTML = `
    <section class="confirm-panel">
      ...
      <div class="detail-actions">
        <a class="button button--primary" href="../../order/read/detail/index.html?id=${order.id}">주문 상세 보기</a>
      </div>
    </section>
  `;
} else {
    ...
    <article class="cart-form-layout">
      ...
      <form class="panel-form" id="payment-form">
        ...
        <div class="detail-actions">
          ...
          <a class="button button--ghost" href="../../order/read/detail/index.html?id=${order.id}">주문 상세</a>
        </div>
      </form>
    </article>
  `;
  ...
  document.getElementById('payment-form').addEventListener('submit', async (event) => {
    ...
    try {
      ...
      window.location.href = `../../order/read/complete/index.html?id=${order.id}`;
    } catch (paymentError) {
